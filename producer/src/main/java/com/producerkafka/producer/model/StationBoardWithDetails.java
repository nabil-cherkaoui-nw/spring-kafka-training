...
public class StationBoardWithDetails {
    ...
    private List<ServiceItemWithCallingPoints> trainServices;
    
    @JsonProperty("busServices")
    private List<ServiceItemWithCallingPoints> busServices;
    
    @JsonProperty("ferryServices")
    private List<ServiceItemWithCallingPoints> ferryServices;
